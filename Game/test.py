...
Title_sound = pygame.mixer.Sound('/Game/Title.mp3')  # 加载游戏主界面音乐
Playing_sound = pygame.mixer.Sound('/Game/Tetris.MP3')  # 加载游戏运行时音乐
line_clear_sound = pygame.mixer.Sound('/Game/TerisEliminate.mp3')  # 加载方块消除音乐
line_clear_sound.set_volume(1.0)  # 设置音量
GameOver_sound = pygame.mixer.Sound('/Game/Game Over.mp3')  # 加载游戏结束音乐
